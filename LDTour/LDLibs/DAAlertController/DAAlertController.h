...
+ (void)showAlertOfStyle:(DAAlertControllerStyle)style
        inViewController:(UIViewController *)viewController
               withTitle:(NSString *)title
                 message:(NSString *)message
                 actions:(NSArray <DAAlertAction *>*)actions;
...
+ (void)showAlertViewInViewController:(UIViewController *)viewController
       ...
       textFieldsConfigurationHandler:(void (^)(NSArray *textFields))configurationHandler
                      validationBlock:(BOOL (^)(NSArray *textFields))validationBlock;
@end